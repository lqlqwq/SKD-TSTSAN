...
from train_classify_SKD_TSTSAN_functions_with_class_3 import main_SKD_TSTSAN_with_Aug_with_SKD
...
if __name__ == '__main__':
    ...
    parser.add_argument('--main_path', type=str, default="Dataset_muti/single", help="path to the dataset directory")
    parser.add_argument('--exp_name', type=str, default="single_class_3_double", help="name of the folder to save experimental results")
